...
/**
 *    定义了4种颜色风格，去掉主函数，可以用这个类直接创建按钮了，
 * @author 132911
 *
 */
public class SwipeCardJButton extends JButton {
	/* 决定圆角的弧度 */
	...
	public SwipeCardJButton() {
		this("", stone);
	}

	public SwipeCardJButton(String name) {
		this(name, stone);
	}

	public SwipeCardJButton(String name, int style) {
		super.setText(name);
		if (style == pink) {
			COLOR1 = pink1;
			COLOR2 = pink2;
...
//	}
	...
	public static void main(String[] args){
		JFrame frm = new JFrame();
		SwipeCardJButton but = new SwipeCardJButton("圆角JButton", 2);
		SwipeCardJButton but1 = new SwipeCardJButton("圆角JButton", 1);
		frm.setLayout(null);
		frm.setBounds(800, 400, 200, 200);
